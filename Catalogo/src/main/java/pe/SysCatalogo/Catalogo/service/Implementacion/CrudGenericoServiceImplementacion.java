...
import pe.SysCatalogo.Catalogo.exception.ModelNotFoundException;
import pe.SysCatalogo.Catalogo.repository.ICrudGenericRepository;
import pe.SysCatalogo.Catalogo.service.ICrudGenericService;

import java.util.List;

public abstract class CrudGenericoServiceImplementacion<T,ID> implements
